...
('Free To Play'), ('Multiplayer'), ('FPS'), ('Action'), ('Open World'),
('Singleplayer'), ('Adventure'), ('Historical'), ('Shooter'), ('PvP'),
('Co-op'), ('Loot'), ('Horror'), ('Hack and Slash'), ('Great Soundtrack'),
...
(1,1),(1,2),(1,9),(1,3),(1,4),(1,18),(1,11),(1,10),
(2,7),(2,6),(2,4),(2,2),
...
select p.*, c.Name as Category, d.Name as Developer
